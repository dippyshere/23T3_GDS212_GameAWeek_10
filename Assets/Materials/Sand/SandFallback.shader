Shader "Custom/Snow Interactive NoTessellation" {
    Properties{
        [Header(Main)]
    ...
    #include "SandFallbackTesselation.hlsl"
    // Keywords
    ...
    SubShader{
        Tags{ "RenderType" = "Opaque" "RenderPipeline" = "UniversalPipeline" "IgnoreProjector" = "False"}
